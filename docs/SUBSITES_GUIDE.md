# Sub-sites Implementation Guide

## 🎉 What's New

Three new sub-sites have been added to the MoirAI platform with a navigation structure similar to **probecarios.com**:

### 1. **Oportunidades** (`/oportunidades`)
- Browse available job opportunities
- Advanced filtering (location, modality, sector, experience level, skills)
- Job cards with match percentage, salary, and required skills
- Pagination and sorting options

### 2. **Empresas** (`/empresas`)
- Explore all collaborating companies
- Filter by sector, size, location, and certifications
- Company cards with stats and badges
- Grid/List view toggle

### 3. **Estudiantes** (`/estudiantes`)
- Discover student profiles
- Filter by career, year, availability, skills, and experience
- Student profile cards with projects completed
- Grid/List view toggle
